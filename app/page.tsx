...
const diningHalls = [
  ...
  { label: 'Windsor Dining Court', href: '/Windsor', image: '/windsor.png'},
  { label: 'Earhart Dining Court', href: '/Earhart', image: '/earhart.png'},
  { label: 'Hillenbrand Dining Court', href: '/Hillenbrand', image: '/hillenbrand.png'},
  { label: 'Ford Dining Court', href: '/Ford', image: '/ford.png'},
];
